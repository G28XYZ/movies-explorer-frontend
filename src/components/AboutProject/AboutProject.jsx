...
const AboutProject = forwardRef((props, ref) => {
  return (
    <section className="project" id="aboutProject" ref={ref}>
      <h2 className="project__title text_subtitle underline-p25">О проекте</h2>
      ...
      <div className="project__duration">
        <div className="project__duration-area">
          <div className="project__duration-time text color_primary">
            1 неделя
          </div>
          <p className="project__duration-name text color_text">Back-end</p>
        </div>
        <div className="project__duration-area">
          <div className="project__duration-time text color_secondary">
            4 недели
          </div>
